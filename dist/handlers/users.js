...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, secret, authHeader, authToken, newUser, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                jsonwebtoken_1.default.verify(authToken, secret);
...
var index = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret, authHeader, authToken, users, token, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                secret = process.env.TOKEN_SECRET;
                authHeader = _req.headers.authorization;
            ...
            case 1:
                users = _a.sent();
                token = jsonwebtoken_1.default.sign({ user: users }, secret);
                res.json(token);
                return [3 /*break*/, 3];
            case 2:
                error_1 = _a.sent();
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var secret, authHeader, authToken, user, token, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                ...
                authToken = authHeader.split(' ')[1];
                jsonwebtoken_1.default.verify(authToken, secret);
                return [4 /*yield*/, userStore.show(_req.params.id)];
            case 1:
                user = _a.sent();
