...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var product, secret, authHeader, authToken, newProduct, token, err_1;
...
var show = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, productStore.show(_req.params.id)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
            case 2:
                ...
                throw new Error("listUsers Error: ".concat(error_2));
            case 3: return [2 /*return*/];
        }
    });
}); };
